...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .titulo-sexto.color-acento-contenido
      h5 Figura 1.
      span Principios que caracterizan al DCU
    ...
    ImagenInfografica.color-acento-botones.mb-5
      ...
      .tarjeta.color-primario.p-3(x="58%" y="20%")
        .h5.mb-0.text-center Evaluación
      .tarjeta.color-primario.p-3(x="42.7%" y="40%")
        .h5.mb-0.text-center Especificación de requisitos
      .tarjeta.color-primario.p-3(x="54.2%" y="46%")
        .h5.mb-0.text-center Cumple con los requerimientos
      .tarjeta.color-primario.p-3(x="39.2%" y="61%")
        .h5.mb-0.text-center Especificación del contexto de uso
      .tarjeta.color-primario.p-3(x="60%" y="70%")
    ...
    .titulo-sexto.color-acento-contenido
      h5 Figura 2.
      span Técnica por fases para el desarrollo de un diseño centrado en el usuario

    .row.mb-5.justify-content-center
      .col-lg-8
        h4.text-center Proceso del DCU y las técnicas por fases
        img(src="@/assets/curso/cf1/img41.jpg")
