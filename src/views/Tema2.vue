...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row.mb-5.justify-content-center(data-aos="zoom-in-up")
      .col-lg-7
        img(src="@/assets/curso/cf1/img18.png")
    ...
    .row.mb-5.justify-content-center(data-aos="zoom-in-up")
      .col-lg-5
        ...
        figure
          img(src="@/assets/curso/cf1/img19.png")
          figcaption Nota. Adaptado de Cuello y Vittone (2013)

    .row.mb-5
      .col-lg-4.col-md-5.col-sm-6.col-xs-auto: img(src="@/assets/curso/cf1/img20.svg").mb-4(data-aos="slide-right")
    ...
    .row.mb-5
      .col-lg-4.col-md-5.col-sm-6.col-xs-auto: img(src="@/assets/curso/cf1/img21.svg").mb-4(data-aos="slide-right")
      .col-lg-8.col-md-7.col-sm-6.col-xs-auto(data-aos="slide-left")
    ...
    .row.mb-5
      .col-lg-4.col-md-5.col-sm-6.col-xs-auto: img(src="@/assets/curso/cf1/img22.svg").mb-4(data-aos="slide-right")
      .col-lg-8.col-md-7.col-sm-6.col-xs-auto(data-aos="slide-left")
      ...
      ModalA(:abrir-modal.sync="modal1")
        .row.justify-content-center
          .col-lg-5.mb-4
            img(src="@/assets/curso/cf1/img30.svg")
    .row.mb-5
      .col-lg-4.col-md-5.col-sm-6.col-xs-auto: img(src="@/assets/curso/cf1/img23.svg").mb-4(data-aos="slide-right")
      .col-lg-8.col-md-7.col-sm-6.col-xs-auto(data-aos="slide-left")
    ...
    .row.mb-5
      .col-md-6.col-lg.mb-5.mb-lg-0
        .tarjeta-avatar.hover-transform
          img(src='@/assets/curso/cf1/img26.svg' alt='AvatarTop').m-auto
      ...
      .col-md-6.col-lg.mb-5.mb-lg-0
        .tarjeta-avatar.hover-transform
          img(src='@/assets/curso/cf1/img27.svg' alt='AvatarTop').m-auto
      ...
      .col-md-6.col-lg.mb-5.mb-lg-0
        .tarjeta-avatar.hover-transform
          img(src='@/assets/curso/cf1/img28.svg' alt='AvatarTop').m-auto
