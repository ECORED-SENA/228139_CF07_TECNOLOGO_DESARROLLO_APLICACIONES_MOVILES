...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.mb-5
      .col-lg-6
        h4 Píxeles
        p La pantalla viene dividida en #[b “superficie de contacto”]; elemento de imagen que consiste en puntos diminutos presentes en toda el área de la pantalla, y permiten que se visualice una imagen. Se puede entender un píxel como el tamaño más pequeño que una imagen puede tener.
      .col-lg-6: img(src='@/assets/curso/cf1/img66.jpg')
    .row.mb-5
      .col-lg-6
    ...
    .row.mb-5
      ...
      .col-lg-6: img(src='@/assets/curso/cf1/img68.jpg')
    .row.mb-5
      .col-lg-6
      ...
      .col-lg-6: img(src='@/assets/curso/cf1/img69.jpg')
</template>
